...
//! document does not contain are silently skipped by these methods.
//!
...
//! the two representations use [`Automerge::hashes_to_change_ids()`] and
//! [`Automerge::change_ids_to_hashes()`] (or their singular counterparts
//! [`Automerge::hash_to_change_id()`] and [`Automerge::change_id_to_hash()`]).
//!
//! ### Actor IDs
//!
