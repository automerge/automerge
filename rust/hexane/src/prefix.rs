...
fn find_prefix_in_slab<T: PrefixValue, C: Codec>(slab: &Slab<TailOf<T, C>>, target: T::Prefix) -> usize
where
...
impl<'a, T: PrefixValue, C: Codec> crate::encoding::RunSrc<'a, T> for PrefixColumnLoadIter<'a, T, C> {
