...
static void test_create_clone_and_free(void** state) {
    ...
    /* const doc1 = create()                                                 */
    AMdoc* const doc1 = AMitemToDoc(AMstackItem(
        stack_ptr, AMcreate(NULL), cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* const doc2 = doc1.clone()                                             */
    AMdoc* const doc2 = AMitemToDoc(AMstackItem(
        stack_ptr, AMclone(doc1), cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
}
...
static void test_start_and_commit(void** state) {
    ...
    AMstack** stack_ptr = &base_state->stack;
    /* const doc = create()                                                  */
    AMdoc* const doc = AMitemToDoc(AMstackItem(
        stack_ptr, AMcreate(NULL), cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* doc.commit()                                                          */
    AMstackItems(stack_ptr, AMemptyChange(doc, AMstr(NULL), NULL), cmocka_cb,
 ...
 */
static void test_getting_a_nonexistent_prop_does_not_throw_an_error(
    void** state) {
    BaseState* base_state = *state;
    AMstack** stack_ptr = &base_state->stack;
    /* const doc = create()                                                  */
    ...
    AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("hello"), NULL),
...
static void test_should_be_able_to_set_and_get_a_simple_value(void** state) {
    ...
    AMdoc* const doc =
        AMitemToDoc(AMstackItem(stack_ptr,
                               AMcreate(AMitemToActorId(AMstackItem(
                                   stack_ptr, AMactorIdFromStr(AMstr("aabbcc")),
    ...
    AMstackItem(NULL, AMmapPutStr(doc, AM_ROOT, AMstr("hello"), AMstr("world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "number1", 5, "uint")                                   */
    AMstackItem(NULL, AMmapPutUint(doc, AM_ROOT, AMstr("number1"), 5), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "number2", 5)                                           */
    AMstackItem(NULL, AMmapPutInt(doc, AM_ROOT, AMstr("number2"), 5), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "number3", 5.5)                                         */
    AMstackItem(NULL, AMmapPutF64(doc, AM_ROOT, AMstr("number3"), 5.5),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "number4", 5.5, "f64")                                  */
    AMstackItem(NULL, AMmapPutF64(doc, AM_ROOT, AMstr("number4"), 5.5),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "number5", 5.5, "int")                                  */
    AMstackItem(NULL, AMmapPutInt(doc, AM_ROOT, AMstr("number5"), 5.5),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "bool", true)                                           */
    AMstackItem(NULL, AMmapPutBool(doc, AM_ROOT, AMstr("bool"), true), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "time1", 1000, "timestamp")                             */
    AMstackItem(NULL, AMmapPutTimestamp(doc, AM_ROOT, AMstr("time1"), 1000),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put(root, "time2", new Date(1001))                                */
    AMstackItem(NULL, AMmapPutTimestamp(doc, AM_ROOT, AMstr("time2"), 1001),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    assert_int_equal(
        AMitemToUint(AMstackItem(stack_ptr,
    ...
    assert_int_equal(
        AMitemToInt(AMstackItem(stack_ptr,
    ...
    assert_float_equal(
        AMitemToF64(AMstackItem(stack_ptr,
                               AMmapGet(doc, AM_ROOT, AMstr("number3"), NULL),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_F64))),
        5.5, DBL_EPSILON);
    /*                                                                       */
    ...
    assert_true(AMitemToBool(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("bool"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_BOOL))));
    /*                                                                       */
    /* doc.put(root, "bool", false, "boolean")                               */
    AMstackItem(NULL, AMmapPutBool(doc, AM_ROOT, AMstr("bool"), false),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* result = doc.getWithType(root, "bool")                                */
    /* assert.deepEqual(result, ["boolean", false])                          */
    assert_false(AMitemToBool(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("bool"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_BOOL))));
    /*                                                                       */
    ...
    assert_int_equal(
        AMitemToTimestamp(
            AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("time1"), NULL),
                       cmocka_cb, AMexpect(AM_VAL_TYPE_TIMESTAMP))),
        1000);
    /*                                                                       */
    ...
    assert_int_equal(
        AMitemToTimestamp(
            AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("time2"), NULL),
                       cmocka_cb, AMexpect(AM_VAL_TYPE_TIMESTAMP))),
        1001);
    /*                                                                       */
    ...
    AMobjId const* const list = AMitemObjId(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("list"), NULL),
    ...
    AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("null"), NULL),
               cmocka_cb, AMexpect(AM_VAL_TYPE_NULL));
}
...
static void test_should_be_able_to_use_bytes(void** state) {
    ...
    AMstackItem(NULL,
               AMmapPutBytes(doc, AM_ROOT, AMstr("data1"),
                             AMbytes(DATA1, sizeof(DATA1))),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put("_root", "data2", new Uint8Array([13, 14, 15]), "bytes");     */
    static uint8_t const DATA2[] = {13, 14, 15};
    AMstackItem(NULL,
               AMmapPutBytes(doc, AM_ROOT, AMstr("data2"),
                             AMbytes(DATA2, sizeof(DATA2))),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const value1 = doc.getWithType("_root", "data1")                      */
    AMbyteSpan const value1 = AMitemToBytes(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("data1"), NULL),
    ...
    AMbyteSpan const value2 = AMitemToBytes(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("data2"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
...
static void test_should_be_able_to_make_subobjects(void** state) {
    ...
    AMobjId const* const submap = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("submap"), AM_OBJ_TYPE_MAP),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* doc.put(submap, "number", 6, "uint")                                  */
    AMstackItem(NULL, AMmapPutUint(doc, submap, AMstr("number"), 6), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
...
static void test_should_be_able_to_make_lists(void** state) {
    ...
    AMobjId const* const sublist = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("numbers"), AM_OBJ_TYPE_LIST),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* doc.insert(sublist, 0, "a");                                          */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 0, true, AMstr("a")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.insert(sublist, 1, "b");                                          */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 1, true, AMstr("b")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.insert(sublist, 2, "c");                                          */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 2, true, AMstr("c")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.insert(sublist, 0, "z");                                          */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 0, true, AMstr("z")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* assert.deepEqual(doc.getWithType(sublist, 0), ["str", "z"])           */
    AMbyteSpan str =
        AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, sublist, 0, NULL),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "z", str.count);
    /* assert.deepEqual(doc.getWithType(sublist, 1), ["str", "a"])           */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, sublist, 1, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "a", str.count);
    /* assert.deepEqual(doc.getWithType(sublist, 2), ["str", "b"])           */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, sublist, 2, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "b", str.count);
    /* assert.deepEqual(doc.getWithType(sublist, 3), ["str", "c"])           */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, sublist, 3, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    ...
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 2, false, AMstr("b v2")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
...
static void test_lists_have_insert_set_splice_and_push_ops(void** state) {
    ...
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 0, true, AMstr("b")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(doc.materialize(), { letters: ["b", "a"] })          */
    AMitem* doc_item = AMstackItem(
        stack_ptr, AMmapRange(doc, AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    ...
    {
        AMitems list_items = AMstackItems(
            stack_ptr,
            AMlistRange(doc, AMitemObjId(doc_item), 0, SIZE_MAX, NULL),
            cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
        assert_int_equal(AMitemsSize(&list_items), 2);
        AMbyteSpan str = AMitemToStr(AMitemsNext(&list_items, 1));
        assert_int_equal(str.count, 1);
        assert_memory_equal(str.src, "b", str.count);
        str = AMitemToStr(AMitemsNext(&list_items, 1));
        assert_int_equal(str.count, 1);
        assert_memory_equal(str.src, "a", str.count);
        assert_null(AMitemsNext(&list_items, 1));
    }
    /* doc.push(sublist, "c");                                               */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, SIZE_MAX, true, AMstr("c")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const heads = doc.getHeads()                                          */
    AMitems const heads = AMstackItems(stack_ptr, AMgetHeads(doc), cmocka_cb,
                                      AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* assert.deepEqual(doc.materialize(), { letters: ["b", "a", "c"] })     */
    doc_item = AMstackItem(
        stack_ptr, AMmapRange(doc, AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    assert_int_equal(AMitemIdxType(doc_item), AM_IDX_TYPE_KEY);
    ...
    AMstackItem(NULL, AMlistPutTimestamp(doc, sublist, SIZE_MAX, true, 3),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    assert_memory_equal(key.src, "letters", key.count);
    {
        ...
        assert_int_equal(str.count, 1);
        assert_memory_equal(str.src, "c", str.count);
        assert_int_equal(AMitemToTimestamp(AMitemsNext(&list_items, 1)), 3);
        assert_null(AMitemsNext(&list_items, 1));
    }
    /* doc.splice(sublist, 1, 1, ["d", "e", "f"]);                           */
    AMresult* data = AMstackResult(
        stack_ptr,
        AMresultFrom(3, AMitemFromStr(AMstr("d")), AMitemFromStr(AMstr("e")),
                     AMitemFromStr(AMstr("f"))),
        NULL, NULL);
    AMstackItem(NULL, AMsplice(doc, sublist, 1, 1, AMresultItems(data)),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    /* doc.put(sublist, 0, "z");                                             */
    AMstackItem(NULL, AMlistPutStr(doc, sublist, 0, false, AMstr("z")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
     ...
     * Date(3)] */
    AMitems sublist_items = AMstackItems(
        stack_ptr, AMlistRange(doc, sublist, 0, SIZE_MAX, NULL), cmocka_cb,
        AMexpect(AM_VAL_TYPE_STR | AM_VAL_TYPE_TIMESTAMP));
    AMbyteSpan str = AMitemToStr(AMitemsNext(&sublist_items, 1));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "z", str.count);
    str = AMitemToStr(AMitemsNext(&sublist_items, 1));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "d", str.count);
    str = AMitemToStr(AMitemsNext(&sublist_items, 1));
    assert_int_equal(str.count, 1);
    ...
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "c", str.count);
    assert_int_equal(AMitemToTimestamp(AMitemsNext(&sublist_items, 1)), 3);
     ...
     * } */
    doc_item = AMstackItem(
        stack_ptr, AMmapRange(doc, AM_ROOT, AMstr(NULL), AMstr(NULL), &heads),
        cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    assert_int_equal(AMitemIdxType(doc_item), AM_IDX_TYPE_KEY);
    key = AMitemKey(doc_item);
    assert_int_equal(key.count, strlen("letters"));
    assert_memory_equal(key.src, "letters", key.count);
    {
        AMitems list_items = AMstackItems(
            stack_ptr,
            AMlistRange(doc, AMitemObjId(doc_item), 0, SIZE_MAX, &heads),
            cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
        AMbyteSpan str = AMitemToStr(AMitemsNext(&list_items, 1));
        assert_int_equal(str.count, 1);
        assert_memory_equal(str.src, "b", str.count);
...
static void test_should_be_able_to_delete_non_existent_props(void** state) {
    ...
    AMstackItem(NULL, AMmapPutStr(doc, AM_ROOT, AMstr("foo"), AMstr("bar")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put("_root", "bip", "bap")                                        */
    AMstackItem(NULL, AMmapPutStr(doc, AM_ROOT, AMstr("bip"), AMstr("bap")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const hash1 = doc.commit()                                            */
    AMitems const hash1 =
        AMstackItems(stack_ptr, AMcommit(doc, AMstr(NULL), NULL), cmocka_cb,
                    AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /*                                                                       */
    /* assert.deepEqual(doc.keys("_root"), ["bip", "foo"])                   */
    AMitems keys = AMstackItems(stack_ptr, AMkeys(doc, AM_ROOT, NULL), cmocka_cb,
                               AMexpect(AM_VAL_TYPE_STR));
    AMbyteSpan str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "bip", str.count);
    str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "foo", str.count);
    /*                                                                       */
    /* doc.delete("_root", "foo")                                            */
    AMstackItem(NULL, AMmapDelete(doc, AM_ROOT, AMstr("foo")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.delete("_root", "baz")                                            */
    AMstackItem(NULL, AMmapDelete(doc, AM_ROOT, AMstr("baz")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    ...
    keys = AMstackItems(stack_ptr, AMkeys(doc, AM_ROOT, NULL), cmocka_cb,
                       AMexpect(AM_VAL_TYPE_STR));
    str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "bip", str.count);
    /* assert.deepEqual(doc.keys("_root", [hash1]), ["bip", "foo"])          */
    keys = AMstackItems(stack_ptr, AMkeys(doc, AM_ROOT, &hash1), cmocka_cb,
                       AMexpect(AM_VAL_TYPE_STR));
    str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "bip", str.count);
    ...
    keys = AMstackItems(stack_ptr, AMkeys(doc, AM_ROOT, &hash2), cmocka_cb,
                       AMexpect(AM_VAL_TYPE_STR));
    str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "bip", str.count);
...
static void test_should_be_able_to_del(void** state) {
    ...
    AMstackItem(NULL, AMmapPutStr(doc, AM_ROOT, AMstr("xxx"), AMstr("xxx")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(doc.getWithType(root, "xxx"), ["str", "xxx"])        */
    AMbyteSpan const str = AMitemToStr(
        AMstackItem(stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("xxx"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 3);
    assert_memory_equal(str.src, "xxx", str.count);
    /* doc.delete(root, "xxx");                                              */
    AMstackItem(NULL, AMmapDelete(doc, AM_ROOT, AMstr("xxx")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(doc.getWithType(root, "xxx"), undefined)             */
    AMstackItem(NULL, AMmapGet(doc, AM_ROOT, AMstr("xxx"), NULL), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
}
...
static void test_should_be_able_to_use_counters(void** state) {
    ...
    AMstackItem(NULL, AMmapPutCounter(doc, AM_ROOT, AMstr("counter"), 10),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(doc.getWithType(root, "counter"), ["counter", 10])   */
    assert_int_equal(
        AMitemToCounter(AMstackItem(
            stack_ptr, AMmapGet(doc, AM_ROOT, AMstr("counter"), NULL),
            cmocka_cb, AMexpect(AM_VAL_TYPE_COUNTER))),
        10);
    /* doc.increment(root, "counter", 10);                                   */
    AMstackItem(NULL, AMmapIncrement(doc, AM_ROOT, AMstr("counter"), 10),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    AMstackItem(NULL, AMmapIncrement(doc, AM_ROOT, AMstr("counter"), -5),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
...
static void test_should_be_able_to_splice_text(void** state) {
    ...
    AMobjId const* const text = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("text"), AM_OBJ_TYPE_TEXT),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* doc.splice(text, 0, 0, "hello ")                                      */
    AMstackItem(NULL, AMspliceText(doc, text, 0, 0, AMstr("hello ")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.splice(text, 6, 0, "world")                                       */
    AMstackItem(NULL, AMspliceText(doc, text, 6, 0, AMstr("world")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc.splice(text, 11, 0, "!?")                                         */
    AMstackItem(NULL, AMspliceText(doc, text, 11, 0, AMstr("!?")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(doc.getWithType(text, 0), ["str", "h"])              */
    AMbyteSpan str =
        AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 0, NULL),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "h", str.count);
    /* assert.deepEqual(doc.getWithType(text, 1), ["str", "e"])              */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 1, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "e", str.count);
    /* assert.deepEqual(doc.getWithType(text, 9), ["str", "l"])              */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 9, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "l", str.count);
    /* assert.deepEqual(doc.getWithType(text, 10), ["str", "d"])             */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 10, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "d", str.count);
    /* assert.deepEqual(doc.getWithType(text, 11), ["str", "!"])             */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 11, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "!", str.count);
    /* assert.deepEqual(doc.getWithType(text, 12), ["str", "?"])             */
    str = AMitemToStr(AMstackItem(stack_ptr, AMlistGet(doc, text, 12, NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "?", str.count);
}
...
static void test_should_be_able_to_save_all_or_incrementally(void** state) {
    ...
    /*                                                                       */
    /* doc.put("_root", "foo", 1)                                            */
    AMstackItem(NULL, AMmapPutInt(doc, AM_ROOT, AMstr("foo"), 1), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* const save1 = doc.save()                                              */
    AMbyteSpan const save1 = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(doc), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    /*                                                                       */
    /* doc.put("_root", "bar", 2)                                            */
    AMstackItem(NULL, AMmapPutInt(doc, AM_ROOT, AMstr("bar"), 2), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* const saveMidway = doc.clone().save();                                */
    AMbyteSpan const saveMidway = AMitemToBytes(AMstackItem(
        stack_ptr,
        AMsave(AMitemToDoc(AMstackItem(stack_ptr, AMclone(doc), cmocka_cb,
                                      AMexpect(AM_VAL_TYPE_DOC)))),
        cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    /*                                                                       */
    /* const save2 = doc.saveIncremental();                                  */
    AMbyteSpan const save2 =
        AMitemToBytes(AMstackItem(stack_ptr, AMsaveIncremental(doc), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_BYTES)));
    /*                                                                       */
    /* doc.put("_root", "baz", 3);                                           */
    AMstackItem(NULL, AMmapPutInt(doc, AM_ROOT, AMstr("baz"), 3), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* const save3 = doc.saveIncremental();                                  */
    AMbyteSpan const save3 =
        AMitemToBytes(AMstackItem(stack_ptr, AMsaveIncremental(doc), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_BYTES)));
    /*                                                                       */
    /* const saveA = doc.save();                                             */
    AMbyteSpan const saveA = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(doc), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    ...
    AMdoc* const docA =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(saveA.src, saveA.count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* const docB = load(saveB);                                             */
    AMdoc* const docB =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(saveB_src, saveB_count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    test_free(saveB_src);
    /* const docC = load(saveMidway)                                         */
    AMdoc* const docC = AMitemToDoc(
        AMstackItem(stack_ptr, AMload(saveMidway.src, saveMidway.count),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* docC.loadIncremental(save3)                                           */
    AMstackItem(NULL, AMloadIncremental(docC, save3.src, save3.count), cmocka_cb,
               AMexpect(AM_VAL_TYPE_UINT));
    /*                                                                       */
    /* assert.deepEqual(docA.keys("_root"), docB.keys("_root"));             */
    AMitems const keysA = AMstackItems(stack_ptr, AMkeys(docA, AM_ROOT, NULL),
                                      cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    AMitems const keysB = AMstackItems(stack_ptr, AMkeys(docB, AM_ROOT, NULL),
                                      cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    assert_true(AMitemsEqual(&keysA, &keysB));
    /* assert.deepEqual(docA.save(), docB.save());                           */
    AMbyteSpan const save = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(docA), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    assert_memory_equal(
        save.src,
        AMitemToBytes(AMstackItem(stack_ptr, AMsave(docB), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_BYTES)))
            .src,
        save.count);
    ...
    assert_memory_equal(
        save.src,
        AMitemToBytes(AMstackItem(stack_ptr, AMsave(docC), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_BYTES)))
            .src,
        save.count);
}
...
static void test_should_be_able_to_splice_text_2(void** state) {
    ...
    AMstackItem(NULL, AMspliceText(doc, text, 0, 0, AMstr("hello world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const hash1 = doc.commit();                                           */
    AMitems const hash1 =
        AMstackItems(stack_ptr, AMcommit(doc, AMstr(NULL), NULL), cmocka_cb,
    ...
    AMstackItem(NULL, AMspliceText(doc, text, 6, 0, AMstr("big bad ")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const hash2 = doc.commit();                                           */
    AMitems const hash2 =
        AMstackItems(stack_ptr, AMcommit(doc, AMstr(NULL), NULL), cmocka_cb,
    ...
    AMbyteSpan str =
        AMitemToStr(AMstackItem(stack_ptr, AMtext(doc, text, NULL), cmocka_cb,
                               AMexpect(AM_VAL_TYPE_STR)));
    ...
    str = AMitemToStr(AMstackItem(stack_ptr, AMtext(doc, text, &hash1),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    ...
    str = AMitemToStr(AMstackItem(stack_ptr, AMtext(doc, text, &hash2),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, strlen("hello big bad world"));
    assert_memory_equal(str.src, "hello big bad world", str.count);
 ...
 */
static void test_local_inc_increments_all_visible_counters_in_a_map(
    void** state) {
    BaseState* base_state = *state;
    AMstack** stack_ptr = &base_state->stack;
    ...
    AMdoc* const doc1 =
        AMitemToDoc(AMstackItem(stack_ptr,
                               AMcreate(AMitemToActorId(AMstackItem(
                                   stack_ptr, AMactorIdFromStr(AMstr("aaaa")),
                                   cmocka_cb, AMexpect(AM_VAL_TYPE_ACTOR_ID)))),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* doc1.put("_root", "hello", "world")                                   */
    AMstackItem(NULL, AMmapPutStr(doc1, AM_ROOT, AMstr("hello"), AMstr("world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const doc2 = load(doc1.save(), "bbbb");                               */
    AMbyteSpan const save = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(doc1), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    AMdoc* const doc2 =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(save.src, save.count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    AMstackItem(
        NULL,
        AMsetActorId(doc2, AMitemToActorId(AMstackItem(
                               stack_ptr, AMactorIdFromStr(AMstr("bbbb")),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_ACTOR_ID)))),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    AMstackItem(
        NULL,
        AMsetActorId(doc3, AMitemToActorId(AMstackItem(
                               stack_ptr, AMactorIdFromStr(AMstr("cccc")),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_ACTOR_ID)))),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* let heads = doc1.getHeads()                                           */
    AMitems const heads1 = AMstackItems(stack_ptr, AMgetHeads(doc1), cmocka_cb,
                                       AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* doc1.put("_root", "cnt", 20)                                          */
    AMstackItem(NULL, AMmapPutInt(doc1, AM_ROOT, AMstr("cnt"), 20), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc2.put("_root", "cnt", 0, "counter")                                */
    AMstackItem(NULL, AMmapPutCounter(doc2, AM_ROOT, AMstr("cnt"), 0), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc3.put("_root", "cnt", 10, "counter")                               */
    AMstackItem(NULL, AMmapPutCounter(doc3, AM_ROOT, AMstr("cnt"), 10),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc1.applyChanges(doc2.getChanges(heads))                             */
    AMitems const changes2 =
        AMstackItems(stack_ptr, AMgetChanges(doc2, &heads1), cmocka_cb,
                    AMexpect(AM_VAL_TYPE_CHANGE));
    AMstackItem(NULL, AMapplyChanges(doc1, &changes2), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc1.applyChanges(doc3.getChanges(heads))                             */
    AMitems const changes3 =
        AMstackItems(stack_ptr, AMgetChanges(doc3, &heads1), cmocka_cb,
                    AMexpect(AM_VAL_TYPE_CHANGE));
    AMstackItem(NULL, AMapplyChanges(doc1, &changes3), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* let result = doc1.getAll("_root", "cnt")                              */
    AMitems result = AMstackItems(
        stack_ptr, AMmapGetAll(doc1, AM_ROOT, AMstr("cnt"), NULL), cmocka_cb,
    ...
    assert_int_equal(AMitemToInt(result_item), 20);
    ...
    assert_int_equal(AMitemToCounter(result_item), 0);
    assert_int_equal(AMobjIdCounter(AMitemObjId(result_item)), 2);
    str = AMactorIdStr(AMobjIdActorId(AMitemObjId(result_item)));
    assert_int_equal(str.count, 4);
    assert_memory_equal(str.src, "bbbb", str.count);
    result_item = AMitemsNext(&result, 1);
    assert_int_equal(AMitemToCounter(result_item), 10);
    assert_int_equal(AMobjIdCounter(AMitemObjId(result_item)), 2);
    str = AMactorIdStr(AMobjIdActorId(AMitemObjId(result_item)));
    assert_int_equal(str.count, 4);
    assert_memory_equal(str.src, "cccc", str.count);
    /* doc1.increment("_root", "cnt", 5)                                     */
    AMstackItem(NULL, AMmapIncrement(doc1, AM_ROOT, AMstr("cnt"), 5), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* result = doc1.getAll("_root", "cnt")                                  */
    result =
        AMstackItems(stack_ptr, AMmapGetAll(doc1, AM_ROOT, AMstr("cnt"), NULL),
                    cmocka_cb, AMexpect(AM_VAL_TYPE_COUNTER));
    /* assert.deepEqual(result, [
         ['counter', 5, '2@bbbb'],
         ['counter', 15, '2@cccc'],
    ...
    result_item = AMitemsNext(&result, 1);
    assert_int_equal(AMitemToCounter(result_item), 5);
    assert_int_equal(AMobjIdCounter(AMitemObjId(result_item)), 2);
    str = AMactorIdStr(AMobjIdActorId(AMitemObjId(result_item)));
    assert_int_equal(str.count, 4);
    assert_memory_equal(str.src, "bbbb", str.count);
    result_item = AMitemsNext(&result, 1);
    assert_int_equal(AMitemToCounter(result_item), 15);
    assert_int_equal(AMobjIdCounter(AMitemObjId(result_item)), 2);
    str = AMactorIdStr(AMobjIdActorId(AMitemObjId(result_item)));
    assert_int_equal(str.count, 4);
    assert_memory_equal(str.src, "cccc", str.count);
    ...
    AMdoc* const doc4 =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(save1.src, save1.count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* assert.deepEqual(doc4.save(), save1);                                 */
    assert_memory_equal(
        AMitemToBytes(AMstackItem(stack_ptr, AMsave(doc4), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_BYTES)))
            .src,
        save1.src, save1.count);
}

/**
 * \brief local inc increments all visible counters in a sequence
 */
static void test_local_inc_increments_all_visible_counters_in_a_sequence(
    void** state) {
    BaseState* base_state = *state;
    AMstack** stack_ptr = &base_state->stack;
    /* const doc1 = create("aaaa")                                           */
    ...
    AMobjId const* const seq = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc1, AM_ROOT, AMstr("seq"), AM_OBJ_TYPE_LIST),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* doc1.insert(seq, 0, "hello")                                          */
    AMstackItem(NULL, AMlistPutStr(doc1, seq, 0, true, AMstr("hello")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const doc2 = load(doc1.save(), "bbbb");                               */
    AMbyteSpan const save1 = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(doc1), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    ...
    AMitems const heads1 = AMstackItems(stack_ptr, AMgetHeads(doc1), cmocka_cb,
                                       AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* doc1.put(seq, 0, 20)                                                  */
    AMstackItem(NULL, AMlistPutInt(doc1, seq, 0, false, 20), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc2.put(seq, 0, 0, "counter")                                        */
    AMstackItem(NULL, AMlistPutCounter(doc2, seq, 0, false, 0), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc3.put(seq, 0, 10, "counter")                                       */
    AMstackItem(NULL, AMlistPutCounter(doc3, seq, 0, false, 10), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* doc1.applyChanges(doc2.getChanges(heads))                             */
    AMitems const changes2 =
        AMstackItems(stack_ptr, AMgetChanges(doc2, &heads1), cmocka_cb,
    ...
    AMitems result =
        AMstackItems(stack_ptr, AMlistGetAll(doc1, seq, 0, NULL), cmocka_cb,
    ...
    AMstackItem(NULL, AMlistIncrement(doc1, seq, 0, 5), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* result = doc1.getAll(seq, 0)                                          */
    result = AMstackItems(stack_ptr, AMlistGetAll(doc1, seq, 0, NULL), cmocka_cb,
...
static void test_should_be_able_to_fetch_changes_by_hash(void** state) {
    ...
    AMdoc* const doc2 =
        AMitemToDoc(AMstackItem(stack_ptr,
                               ...
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* doc1.put("/", "a", "b")                                               */
    AMstackItem(NULL, AMmapPutStr(doc1, AM_ROOT, AMstr("a"), AMstr("b")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc2.put("/", "b", "c")                                               */
    AMstackItem(NULL, AMmapPutStr(doc2, AM_ROOT, AMstr("b"), AMstr("c")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const head1 = doc1.getHeads()                                         */
    AMitems head1 = AMstackItems(stack_ptr, AMgetHeads(doc1), cmocka_cb,
                                AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* const head2 = doc2.getHeads()                                         */
    AMitems head2 = AMstackItems(stack_ptr, AMgetHeads(doc2), cmocka_cb,
                                AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* const change1 = doc1.getChangeByHash(head1[0])
       if (change1 === null) { throw new RangeError("change1 should not be
       null")  */
    AMbyteSpan const change_hash1 = AMitemToChangeHash(AMitemsNext(&head1, 1));
    ...
    AMbyteSpan const change_hash2 = AMitemToChangeHash(AMitemsNext(&head2, 1));
    AMstackItem(NULL,
               AMgetChangeByHash(doc1, change_hash2.src, change_hash2.count),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(decodeChange(change1).hash, head1[0])                */
    assert_memory_equal(
        AMchangeHash(AMitemToChange(AMitemsNext(&change1, 1))).src,
        change_hash1.src, change_hash1.count);
}
...
static void test_recursive_sets_are_possible(void** state) {
    ...
    AMobjId const* const l1 = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("list"), AM_OBJ_TYPE_LIST),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    {
        AMobjId const* const map = AMitemObjId(AMstackItem(
            stack_ptr, AMlistPutObject(doc, l1, 0, true, AM_OBJ_TYPE_MAP),
            cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
        AMstackItem(NULL, AMmapPutStr(doc, map, AMstr("foo"), AMstr("bar")),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
        ...
        for (int value = 1; value != 4; ++value) {
            AMstackItem(NULL, AMlistPutInt(doc, list, SIZE_MAX, true, value),
                       cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
        }
    }
    /* const l2 = doc.insertObject(l1, 0, { zip: ["a", "b"] })               */
    AMobjId const* const l2 = AMitemObjId(AMstackItem(
        stack_ptr, AMlistPutObject(doc, l1, 0, true, AM_OBJ_TYPE_MAP),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    {
        AMobjId const* const list = AMitemObjId(AMstackItem(
            stack_ptr, AMmapPutObject(doc, l2, AMstr("zip"), AM_OBJ_TYPE_LIST),
            cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
        AMstackItem(NULL, AMlistPutStr(doc, list, SIZE_MAX, true, AMstr("a")),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
        AMstackItem(NULL, AMlistPutStr(doc, list, SIZE_MAX, true, AMstr("b")),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    }
    /* const l3 = doc.putObject("_root", "info1", "hello world") // 'text'
     * object */
    AMobjId const* const l3 = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("info1"), AM_OBJ_TYPE_TEXT),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    AMstackItem(NULL, AMspliceText(doc, l3, 0, 0, AMstr("hello world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* doc.put("_root", "info2", "hello world")  // 'str'                    */
    AMstackItem(NULL,
               AMmapPutStr(doc, AM_ROOT, AMstr("info2"), AMstr("hello world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const l4 = doc.putObject("_root", "info3", "hello world")             */
    AMobjId const* const l4 = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("info3"), AM_OBJ_TYPE_TEXT),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    AMstackItem(NULL, AMspliceText(doc, l4, 0, 0, AMstr("hello world")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    ...
    AMitems doc_items = AMstackItems(
        stack_ptr, AMmapRange(doc, AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
    ...
    AMbyteSpan str = AMitemToStr(
        AMstackItem(stack_ptr, AMtext(doc, AMitemObjId(doc_item), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, strlen("hello world"));
    assert_memory_equal(str.src, "hello world", str.count);
    ...
    str = AMitemToStr(AMstackItem(stack_ptr,
                                 AMtext(doc, AMitemObjId(doc_item), NULL),
                                 cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, strlen("hello world"));
    assert_memory_equal(str.src, "hello world", str.count);
    doc_item = AMitemsNext(&doc_items, 1);
    ...
    assert_memory_equal(key.src, "list", key.count);
    {
        ...
        {
            AMitems map_items =
                AMstackItems(stack_ptr,
                            AMmapRange(doc, AMitemObjId(list_item), AMstr(NULL),
                                       AMstr(NULL), NULL),
                            cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
            ...
            assert_memory_equal(key.src, "zip", key.count);
            {
                AMitems list_items = AMstackItems(
                    stack_ptr,
                    AMlistRange(doc, AMitemObjId(map_item), 0, SIZE_MAX, NULL),
                    cmocka_cb,
        ...
        {
            AMitems map_items = AMstackItems(
                stack_ptr,
                AMmapRange(doc, AMitemObjId(list_item), AMstr(NULL),
                           AMstr(NULL), NULL),
                cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE | AM_VAL_TYPE_STR));
            ...
            AMbyteSpan const str = AMitemToStr(map_item);
            assert_int_equal(str.count, 3);
        ...
        list_item = AMitemsNext(&list_items, 1);
        {
            AMitems list_items = AMstackItems(
                stack_ptr,
                AMlistRange(doc, AMitemObjId(list_item), 0, SIZE_MAX, NULL),
                cmocka_cb, AMexpect(AM_VAL_TYPE_INT));
            assert_int_equal(AMitemToInt(AMitemsNext(&list_items, 1)), 1);
            assert_int_equal(AMitemToInt(AMitemsNext(&list_items, 1)), 2);
            assert_int_equal(AMitemToInt(AMitemsNext(&list_items, 1)), 3);
        }
    }
    /* assert.deepEqual(doc.materialize(l2), { zip: ["a", "b"] })            */
    AMitems map_items = AMstackItems(
        stack_ptr, AMmapRange(doc, l2, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    AMitem const* map_item = AMitemsNext(&map_items, 1);
    assert_int_equal(AMitemIdxType(map_item), AM_IDX_TYPE_KEY);
     ...
     * }, [1, 2, 3]] */
    AMitems list_items =
        AMstackItems(stack_ptr, AMlistRange(doc, l1, 0, SIZE_MAX, NULL),
                    cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    AMitem const* list_item = AMitemsNext(&list_items, 1);
    {
        AMitems map_items =
    ...
    str = AMitemToStr(AMstackItem(stack_ptr, AMtext(doc, l4, NULL), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, strlen("hello world"));
    assert_memory_equal(str.src, "hello world", str.count);
}
 ...
 */
static void test_only_returns_an_object_id_when_objects_are_created(
    void** state) {
    BaseState* base_state = *state;
    AMstack** stack_ptr = &base_state->stack;
    /* const doc = create("aaaa")                                            */
    ...
    AMobjId const* const r2 = AMitemObjId(AMstackItem(
        stack_ptr,
        AMmapPutObject(doc, AM_ROOT, AMstr("list"), AM_OBJ_TYPE_LIST),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    ...
    AMstackItem(NULL, AMmapIncrement(doc, AM_ROOT, AMstr("counter"), 1),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const r5 = doc.delete("_root", "counter")
       assert.deepEqual(r5, null);                                           */
    AMstackItem(NULL, AMmapDelete(doc, AM_ROOT, AMstr("counter")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* const r6 = doc.insert(r2, 0, 10);
       assert.deepEqual(r6, null);                                           */
    AMstackItem(NULL, AMlistPutInt(doc, r2, 0, true, 10), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* const r7 = doc.insertObject(r2, 0, {});                               */
    AMobjId const* const r7 = AMitemObjId(AMstackItem(
        stack_ptr, AMlistPutObject(doc, r2, 0, true, AM_OBJ_TYPE_LIST),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* const r8 = doc.splice(r2, 1, 0, ["a", "b", "c"]);                     */
    AMresult* data = AMstackResult(
        stack_ptr,
        AMresultFrom(3, AMitemFromStr(AMstr("a")), AMitemFromStr(AMstr("b")),
                     AMitemFromStr(AMstr("c"))),
        NULL, NULL);
    AMstackItem(NULL, AMsplice(doc, r2, 1, 0, AMresultItems(data)), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
...
static void test_objects_without_properties_are_preserved(void** state) {
    ...
    AMobjId const* const a = AMitemObjId(AMstackItem(
        stack_ptr, AMmapPutObject(doc1, AM_ROOT, AMstr("a"), AM_OBJ_TYPE_MAP),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* const b = doc1.putObject("_root", "b", {});                           */
    AMobjId const* const b = AMitemObjId(AMstackItem(
        stack_ptr, AMmapPutObject(doc1, AM_ROOT, AMstr("b"), AM_OBJ_TYPE_MAP),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* const c = doc1.putObject("_root", "c", {});                           */
    AMobjId const* const c = AMitemObjId(AMstackItem(
        stack_ptr, AMmapPutObject(doc1, AM_ROOT, AMstr("c"), AM_OBJ_TYPE_MAP),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* const d = doc1.put(c, "d", "dd");                                     */
    AMstackItem(NULL, AMmapPutStr(doc1, c, AMstr("d"), AMstr("dd")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* const saved = doc1.save();                                            */
    AMbyteSpan const saved = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(doc1), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    /* const doc2 = load(saved);                                             */
    AMdoc* const doc2 =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(saved.src, saved.count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* assert.deepEqual(doc2.getWithType("_root", "a"), ["map", a])          */
    AMitems doc_items = AMstackItems(
        stack_ptr, AMmapRange(doc2, AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE));
    assert_true(AMobjIdEqual(AMitemObjId(AMitemsNext(&doc_items, 1)), a));
    /* assert.deepEqual(doc2.keys(a), [])                                    */
    AMitems keys = AMstackItems(stack_ptr, AMkeys(doc1, a, NULL), cmocka_cb,
                               AMexpect(AM_VAL_TYPE_STR));
    ...
    keys = AMstackItems(stack_ptr, AMkeys(doc1, b, NULL), cmocka_cb,
                       AMexpect(AM_VAL_TYPE_STR));
    assert_int_equal(AMitemsSize(&keys), 0);
    ...
    keys = AMstackItems(stack_ptr, AMkeys(doc1, c, NULL), cmocka_cb,
                       AMexpect(AM_VAL_TYPE_STR));
    AMbyteSpan str = AMitemToStr(AMitemsNext(&keys, 1));
    assert_int_equal(str.count, 1);
    assert_memory_equal(str.src, "d", str.count);
    /* assert.deepEqual(doc2.getWithType(c, "d"), ["str", "dd"])             */
    AMitems obj_items = AMstackItems(stack_ptr, AMobjItems(doc1, c, NULL),
                                    cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    str = AMitemToStr(AMitemsNext(&obj_items, 1));
...
static void test_should_allow_you_to_forkAt_a_heads(void** state) {
    ...
    AMdoc* const A =
        AMitemToDoc(AMstackItem(stack_ptr,
                               AMcreate(AMitemToActorId(AMstackItem(
                                   stack_ptr, AMactorIdFromStr(AMstr("aaaaaa")),
                                   cmocka_cb, AMexpect(AM_VAL_TYPE_ACTOR_ID)))),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /* A.put("/", "key1", "val1");                                           */
    AMstackItem(NULL, AMmapPutStr(A, AM_ROOT, AMstr("key1"), AMstr("val1")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* A.put("/", "key2", "val2");                                           */
    AMstackItem(NULL, AMmapPutStr(A, AM_ROOT, AMstr("key2"), AMstr("val2")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* const heads1 = A.getHeads();                                          */
    AMitems const heads1 = AMstackItems(stack_ptr, AMgetHeads(A), cmocka_cb,
                                       AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* const B = A.fork("bbbbbb")                                            */
    AMdoc* const B = AMitemToDoc(AMstackItem(
        stack_ptr, AMfork(A, NULL), cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    AMstackItem(NULL,
               AMsetActorId(B, AMitemToActorId(AMstackItem(
                                   stack_ptr, AMactorIdFromStr(AMstr("bbbbbb")),
                                   cmocka_cb, AMexpect(AM_VAL_TYPE_ACTOR_ID)))),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* A.put("/", "key3", "val3");                                           */
    AMstackItem(NULL, AMmapPutStr(A, AM_ROOT, AMstr("key3"), AMstr("val3")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* B.put("/", "key4", "val4");                                           */
    AMstackItem(NULL, AMmapPutStr(B, AM_ROOT, AMstr("key4"), AMstr("val4")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* A.merge(B)                                                            */
    AMstackItem(NULL, AMmerge(A, B), cmocka_cb,
               AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* const heads2 = A.getHeads();                                          */
    AMitems const heads2 = AMstackItems(stack_ptr, AMgetHeads(A), cmocka_cb,
                                       AMexpect(AM_VAL_TYPE_CHANGE_HASH));
    /* A.put("/", "key5", "val5");                                           */
    AMstackItem(NULL, AMmapPutStr(A, AM_ROOT, AMstr("key5"), AMstr("val5")),
               cmocka_cb, AMexpect(AM_VAL_TYPE_VOID));
    /* assert.deepEqual(A.forkAt(heads1).materialize("/"), A.materialize("/",
     * heads1) */
    AMitems AforkAt1_items = AMstackItems(
        stack_ptr,
        AMmapRange(
            AMitemToDoc(AMstackItem(stack_ptr, AMfork(A, &heads1), cmocka_cb,
                                   AMexpect(AM_VAL_TYPE_DOC))),
            AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    AMitems A1_items = AMstackItems(
        stack_ptr, AMmapRange(A, AM_ROOT, AMstr(NULL), AMstr(NULL), &heads1),
        cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    assert_true(AMitemsEqual(&AforkAt1_items, &A1_items));
    /* assert.deepEqual(A.forkAt(heads2).materialize("/"), A.materialize("/",
     * heads2) */
    AMitems AforkAt2_items = AMstackItems(
        stack_ptr,
        AMmapRange(
            AMitemToDoc(AMstackItem(stack_ptr, AMfork(A, &heads2), cmocka_cb,
                                   AMexpect(AM_VAL_TYPE_DOC))),
            AM_ROOT, AMstr(NULL), AMstr(NULL), NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
    AMitems A2_items = AMstackItems(
        stack_ptr, AMmapRange(A, AM_ROOT, AMstr(NULL), AMstr(NULL), &heads2),
        cmocka_cb, AMexpect(AM_VAL_TYPE_STR));
 ...
 */
static void test_should_handle_merging_text_conflicts_then_saving_and_loading(
    void** state) {
    BaseState* base_state = *state;
    AMstack** stack_ptr = &base_state->stack;
    ...
    AMobjId const* const At = AMitemObjId(AMstackItem(
        stack_ptr, AMmapPutObject(A, AM_ROOT, AMstr("text"), AM_OBJ_TYPE_TEXT),
        cmocka_cb, AMexpect(AM_VAL_TYPE_VOID)));
    /* A.splice(At, 0, 0, 'hello')                                           */
    AMstackItem(NULL, AMspliceText(A, At, 0, 0, AMstr("hello")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* const B = A.fork()                                                    */
    AMdoc* const B = AMitemToDoc(AMstackItem(
    ...
    AMbyteSpan str = AMitemToStr(AMstackItem(
        stack_ptr,
        AMtext(B,
               AMitemObjId(AMstackItem(
                   stack_ptr, AMmapGet(B, AM_ROOT, AMstr("text"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE))),
               NULL),
        cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    AMbyteSpan const str2 = AMitemToStr(AMstackItem(
        stack_ptr, AMtext(A, At, NULL), cmocka_cb, AMexpect(AM_VAL_TYPE_STR)));
    assert_int_equal(str.count, str2.count);
    assert_memory_equal(str.src, str2.src, str.count);
    /*                                                                       */
    /* B.splice(At, 4, 1)                                                    */
    AMstackItem(NULL, AMspliceText(B, At, 4, 1, AMstr(NULL)), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* B.splice(At, 4, 0, '!')                                               */
    AMstackItem(NULL, AMspliceText(B, At, 4, 0, AMstr("!")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* B.splice(At, 5, 0, ' ')                                               */
    AMstackItem(NULL, AMspliceText(B, At, 5, 0, AMstr(" ")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /* B.splice(At, 6, 0, 'world')                                           */
    AMstackItem(NULL, AMspliceText(B, At, 6, 0, AMstr("world")), cmocka_cb,
               AMexpect(AM_VAL_TYPE_VOID));
    /*                                                                       */
    /* A.merge(B)                                                            */
    AMstackItem(NULL, AMmerge(A, B), cmocka_cb,
    ...
    /*                                                                       */
    /* const binary = A.save()                                               */
    AMbyteSpan const binary = AMitemToBytes(AMstackItem(
        stack_ptr, AMsave(A), cmocka_cb, AMexpect(AM_VAL_TYPE_BYTES)));
    /*                                                                       */
    /* const C = load(binary)                                                */
    AMdoc* const C =
        AMitemToDoc(AMstackItem(stack_ptr, AMload(binary.src, binary.count),
                               cmocka_cb, AMexpect(AM_VAL_TYPE_DOC)));
    /*                                                                       */
    /* assert.deepEqual(C.getWithType('_root', 'text'), ['text', '1@aabbcc'] */
    AMobjId const* const C_text = AMitemObjId(
        AMstackItem(stack_ptr, AMmapGet(C, AM_ROOT, AMstr("text"), NULL),
                   cmocka_cb, AMexpect(AM_VAL_TYPE_OBJ_TYPE)));
    ...
    str = AMitemToStr(AMstackItem(stack_ptr, AMtext(C, At, NULL), cmocka_cb,
                                 AMexpect(AM_VAL_TYPE_STR)));
...
int run_ported_wasm_basic_tests(void) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown(test_create_clone_and_free, setup_base,
                                        teardown_base),
        cmocka_unit_test_setup_teardown(test_start_and_commit, setup_base,
                                        teardown_base),
        cmocka_unit_test_setup_teardown(
            test_getting_a_nonexistent_prop_does_not_throw_an_error, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(
            test_should_be_able_to_set_and_get_a_simple_value, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_use_bytes,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_make_subobjects,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_make_lists,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_lists_have_insert_set_splice_and_push_ops, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(
            test_should_be_able_to_delete_non_existent_props, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_del, setup_base,
                                        teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_use_counters,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_splice_text,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_should_be_able_to_save_all_or_incrementally, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(test_should_be_able_to_splice_text_2,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_local_inc_increments_all_visible_counters_in_a_map, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(
            test_local_inc_increments_all_visible_counters_in_a_sequence,
            setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_should_be_able_to_fetch_changes_by_hash, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(test_recursive_sets_are_possible,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_only_returns_an_object_id_when_objects_are_created, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(
            test_objects_without_properties_are_preserved, setup_base,
            teardown_base),
        cmocka_unit_test_setup_teardown(test_should_allow_you_to_forkAt_a_heads,
                                        setup_base, teardown_base),
        cmocka_unit_test_setup_teardown(
            test_should_handle_merging_text_conflicts_then_saving_and_loading,
            setup_base, teardown_base)};
