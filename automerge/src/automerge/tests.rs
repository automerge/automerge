...
#[test]
fn list_range_back_and_forth_single() {
    let mut doc = AutoCommit::new();
    let actor = doc.get_actor().clone();
    ...
    let mut range_all = doc.list_range(&list, ..);
    assert_eq!(
        range_all.next(),
        Some((0, "a".into(), ExId::Id(2, actor.clone(), 0)))
    );
    assert_eq!(
        range_all.next_back(),
        Some((2, "c".into(), ExId::Id(4, actor.clone(), 0)))
    );
    assert_eq!(
        range_all.next_back(),
        Some((1, "b".into(), ExId::Id(3, actor.clone(), 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
    ...
    assert_eq!(
        range_all.next(),
        Some((1, Value::str("b"), ExId::Id(3, actor.clone(), 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
    ...
    assert_eq!(
        range_all.next_back(),
        Some((0, "a".into(), ExId::Id(2, actor, 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
}
...
#[test]
fn list_range_at_back_and_forth_single() {
    let mut doc = AutoCommit::new();
    let actor = doc.get_actor().clone();
    ...
    let mut range_all = doc.list_range_at(ROOT, .., &heads);
    assert_eq!(
        range_all.next(),
        Some((0, "a".into(), ExId::Id(1, actor.clone(), 0)))
    );
    assert_eq!(
        range_all.next_back(),
        Some((2, "c".into(), ExId::Id(3, actor.clone(), 0)))
    );
    assert_eq!(
        range_all.next_back(),
        Some((1, "b".into(), ExId::Id(2, actor.clone(), 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
    ...
    assert_eq!(
        range_all.next(),
        Some((1, Value::str("b"), ExId::Id(2, actor.clone(), 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
    ...
    assert_eq!(
        range_all.next_back(),
        Some((0, "a".into(), ExId::Id(1, actor, 0)))
    );
    assert_eq!(range_all.next_back(), None);
    assert_eq!(range_all.next(), None);
}
...
#[test]
fn list_range_at_back_and_forth_double() {
    let mut doc1 = AutoCommit::new();
    doc1.set_actor(ActorId::from([0]));
    ...
    let mut range_all = doc1.list_range_at(ROOT, .., &heads);
    assert_eq!(
        range_all.next(),
