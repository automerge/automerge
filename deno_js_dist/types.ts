...
import type { Patch } from "https://deno.land/x/automerge_wasm@0.2.12/index.d.ts";
export type { Cursor, Patch, Mark, MarkRange } from "https://deno.land/x/automerge_wasm@0.2.12/index.d.ts";
