import {
  ...
  type LoadOptions,
  type InitOptions,
} from "https://deno.land/x/automerge_wasm@0.6.0-alpha.1/automerge_wasm.js";
export type { ChangeToEncode } from "https://deno.land/x/automerge_wasm@0.6.0-alpha.1/index.d.ts";
